...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-background/95 flex items-center justify-center">
      ...
      <div className="racing-stripes text-center py-4">
        <div className="glow-pulse w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary/60 mx-auto mb-6 flex items-center justify-center">
          <span className="text-3xl font-black">T</span>
        </div>
        <h1 className="text-2xl font-black text-gradient">TORQUE</h1>
